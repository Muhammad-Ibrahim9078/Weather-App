...
function SearchBtn() {
    ...
    .then((data) => {
        ...
        <div class="d-flex justify-content-center">
            <img src="https://cdn.dribbble.com/userupload/25398855/file/original-b39f61791073c4efb3ba40bf4167eb31.gif" width="160px" class="rounded">
        </div>
        ...
        <p class="display-9 mb-0 "><b>feels_like:</b> ${data.main.feels_like}</p>
